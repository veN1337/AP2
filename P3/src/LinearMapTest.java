...
public class LinearMapTest {
     ...
     * Größe, die im Programm berücksichtigt werden darf! Sie könnte z.B. auch
    ...
    /**
     * Verlangt, dass ein gerade konstruiertes Objekt, leer ist. Es dürfen keine
     ...
     * wiederfinden lässt. Zusätzlich wird verlangt, dass nicht unnötig viele
    ...
    /**
     * Wurde hashCode für den Vergleich benutzt?
     */
    @Test
    ...
    public void testOverwriting() {
        objTable.put(K1, K2);
        assertSame("das eingetragene Objekt kommt nicht wieder zurück", K2,
            objTable.get(K1));
        objTable.put(K1, K3);
     ...
     * vorhergehende Wert oder <code>null</code> zurückgegeben werden. Es ist
     * kein Fehler, ein nicht vorhandenes Element zu entfernen.
     */
    @Test
    public void testRemove() {
        assertNull("es muss null zurückgegeben werden", objTable.remove(K1));
        objTable.put(K1, "x");
        objTable.put(K2, "a");
        objTable.put(K3, K1);
        ...
        assertTrue("andere Werte wurden mitgelöscht",
                objTable.containsKey(K1));
    ...
    /**
     * Verlangt, dass die Tabelle mit <code>null</code> Argumenten für Value
     * richtig umgeht.
     */
    @Test
    public void testNullValue() {
        ...
        assertNull("die Rückgabe müsste null sein", objTable.get(""));
    }

    /**
     * Testet ob die Rückgabe von <code>keys()</code> wirklich ein Feld mit
     * genau allen Schlüsseln ist.
     */
    @Test
    public void testKeys() {
        ...
        assertTrue("es wurden nicht alle Schlüssel kopiert", keySet.isEmpty());
    }

    /**
     * Testet eine großer Anzahl von Operationen. Damit soll vor allem die
